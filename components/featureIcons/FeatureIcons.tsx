    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="none">
        ...
        <path
          stroke="#0891B2"
          strokeWidth="4.991"
          d="M53.333 53.337l10-.002c5.523 0 10.001 4.476 10.002 9.998 0 5.523-4.476 10.001-9.999 10.002-5.522.001-10-4.475-10.001-9.998l-.002-10zm-26.663 0l-10-.002c-5.523 0-10 4.476-10.002 9.998 0 5.523 4.476 10.001 9.999 10.002 5.522.001 10-4.475 10.001-9.998l.002-10zm26.663-26.67l10 .001c5.523.001 10.001-4.475 10.002-9.998 0-5.523-4.476-10-9.999-10.002-5.522 0-10 4.476-10.001 9.999l-.002 10zm-26.663 0l-10 .001c-5.523.001-10-4.475-10.002-9.998 0-5.523 4.476-10 9.999-10.002 5.522 0 10 4.476 10.001 9.999l.002 10z"
        ></path>
      </svg>
    );
  }
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="none">
        <path
          stroke="#0891B2"
          strokeWidth="4.991"
          d="M49.859 30.237L39.999 40l-9.858-9.763c-9.742-9.647-14.613-14.47-13.249-18.632.117-.358.263-.706.435-1.04C19.335 6.666 26.223 6.666 40 6.666c13.777 0 20.665 0 22.672 3.897.173.335.318.683.436 1.04 1.363 4.163-3.508 8.986-13.25 18.633z"
        ></path>
        <path
          stroke="#0891B2"
          strokeOpacity="0.5"
          strokeWidth="4.991"
          d="M30.14 49.763L40 40l9.859 9.763C59.6 59.41 64.47 64.233 63.108 68.395a7.104 7.104 0 01-.436 1.04c-2.007 3.898-8.895 3.898-22.672 3.898-13.777 0-20.665 0-22.673-3.897a7.104 7.104 0 01-.435-1.041c-1.364-4.162 3.507-8.985 13.249-18.632z"
        ></path>
      </svg>
    );
  }